...
export default function NewInstitutionPage() {
  ...
  const [program, setProgram] = useState("Academic Pro");
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-[14px] text-[#6B7280]">
          Create a new institutional tenant with an admin account.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="rounded-[8px] border border-[#E5E7EB] bg-white p-6 shadow-[0_1px_3px_rgba(26,26,46,0.08)]">
        <div className="space-y-5">
          ...
          <div>
            <label htmlFor="program" className="block text-[12px] font-bold tracking-[0.6px] text-[#1A1A2E]">
              PROGRAM PLAN
            </label>
            <select
              id="program"
          ...
          <div className="border-t border-[#E5E7EB] pt-5">
            ...
            <p className="mt-1 text-[13px] text-[#6B7280]">
              The primary admin for this institution.
            </p>
          </div>
