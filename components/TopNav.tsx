  ...
  return (
    <header className="flex h-16 shrink-0 items-center gap-4 border-b border-border bg-background/80 px-6 backdrop-blur">
      <div className="relative w-full max-w-sm">
        ...
        <input
          type="search"
          placeholder="Search courses, people, posts…"
          className="w-full rounded-pill border border-border bg-surface py-2 pl-9 pr-3 text-[14px] text-text-primary outline-none transition focus:border-blue focus:bg-background focus:ring-2 focus:ring-blue/10"
        />
      </div>
